...
public class TemporalCardDataBase : Singleton<TemporalCardDataBase>
{
    Dictionary<int, CharacterStats> characterStats = new() {
        ...
        { 21, new CharacterStats("Chicken",1, 2, 7,  1, MovementType.Basic, "Al recibir daño el atacante recibe 16 de daño") }, // Chicken
        { 22, new CharacterStats("Radev",4, 11, 17,  1, MovementType.Basic, "Ciro Di Marzio") }, // Radev
        { 23, new CharacterStats("Richard",5, 15, 20,  1, MovementType.Basic, "El padrino") }, // Richard
        { 24, new CharacterStats("Joan",3, 8, 15,  1, MovementType.Basic, "S'esta passant el Halo") }, // Joan
        ...
        { 29, new CharacterStats("Mokiel",1, 3, 5,  1, MovementType.Basic, "Juga al Call of Duty (de Roblox)") }, // Mokiel
        { 30, new CharacterStats("Pinsa",1, 3, 7,  1, MovementType.Basic, "El programador que no programa") }, // Pinsa
        { 31, new CharacterStats("Sergi",2, 6, 7,  1, MovementType.Basic, "Ballarí professional de bachata") }, // Sergi
        { 32, new CharacterStats("Ferryklk",3, 10, 10,  1, MovementType.Basic, "Jugador professional del Habbo") }, // Ferryklk
        { 33, new CharacterStats("Carla",4, 9, 21,  1, MovementType.Basic, "Té un caball") }, // Carla
        { 34, new CharacterStats("Kiku",5, 12, 24,  1, MovementType.Basic, "El otro artist") }, // Kiku
