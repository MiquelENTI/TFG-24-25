...
public class SelectToken : MonoBehaviour
{
    ...
    void Start()
    {
        CharacterStats stats = new CharacterStats(0, 5, 10, 1000, MovementType.Diagonal, "Y una descripcion mas larga");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(1)) // Clic derecho
        {
            ...
            // Realizar Raycast desde la cámara hacia la posición del ratón
